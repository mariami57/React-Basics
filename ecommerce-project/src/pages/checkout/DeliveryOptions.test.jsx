...
describe('DeliveryOptions component', () => {
    ...
    it('renders delivery options correctly', () => {
        ...
        expect(within(deliveryOptionElems[0]).getByTestId('delivery-option-date')).toHaveTextContent('Sunday, May 18');
        expect(within(deliveryOptionElems[0]).getByTestId('delivery-option-price')).toHaveTextContent('FREE Shipping');
        expect(
