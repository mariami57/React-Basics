...
describe('Checkout page component', () => {
    ...
    it('displays the page correctly', async () => {
        ...
        const paymentSummary = await screen.findByTestId('payment-product-cost');

        expect(axios.get).toHaveBeenNthCalledWith(
            1, '/api/delivery-options?expand=estimatedDeliveryTime');
        ...
        expect(screen.getByTestId('payment-product-cost'))
            .toHaveTextContent('Items (3):');
        expect(screen.getByTestId('payment-shipping-cost'))
